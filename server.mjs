...
const DEFAULT_MAX_INGEST_MEDIA_BYTES = IS_SERVERLESS_RUNTIME ? (600 * 1024 * 1024) : (1024 * 1024 * 1024);
const DEFAULT_MAX_INGEST_DURATION_SECONDS = IS_SERVERLESS_RUNTIME ? (4 * 60 * 60) : (4 * 60 * 60);
